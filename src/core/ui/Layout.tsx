...
export function Layout({ children, fullscreen = false }: LayoutProps) {
    ...
    return (
        <div className="relative w-full h-[100dvh] overflow-hidden bg-game-bg text-white font-pixel flex flex-col">
            ...
            <main className="relative z-10 flex-1 w-full max-w-screen-2xl mx-auto h-full overflow-y-auto overflow-x-hidden">
                <div className="w-full min-h-full flex flex-col items-center justify-center p-4 sm:p-6 lg:p-12 pb-12 sm:pb-0">
                    {children}
                </div>
            </main>
        </div>
